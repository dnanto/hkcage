...
def hkcagetest(session, h, k, H=1, K=1, symmetry=5, edge_radius=0.01, color=(255, 0, 255, 255), replace=True):
    from .cageTest import show_hk_lattice
    show_hk_lattice(session, h, k, H, K, symmetry, edge_radius, color, replace)
