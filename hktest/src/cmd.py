...
# -----------------------------------------------------------------------------
#
def hkcagetest(session, h, k, H = None, K = None, symmetry="e", radius = 100.0, orientation = '222', 
               color = (255,255,255,255), sphere_factor = 0.0, edge_radius = None, mesh = False, replace = True, alpha = 1):
